...
| `A03` | `とうおるるるる...` | full uplink call | P0 |
| `A04` | `とぅるるるる...` | shortened transmission | P1 |
...
| `A09` | `...るる` | delayed identity ping | P1 |
| `A10` | `るる...` + clause | pre-clause identity ping | P1 |
| `A11` | clause + `...るる` | trailing identity ping | derived |
